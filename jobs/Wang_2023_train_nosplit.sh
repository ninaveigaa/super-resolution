...
#SBATCH -t 20:00:00
#SBATCH -J Wang_2023_train_nosplit
#SBATCH -o /mimer/NOBACKUP/groups/kthmech/nvlmds/super-resolution/logs/Wang_2023_train_nosplit_%j.out
#SBATCH -e /mimer/NOBACKUP/groups/kthmech/nvlmds/super-resolution/logs/Wang_2023_train_nosplit_%j.err

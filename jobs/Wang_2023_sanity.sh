...
#SBATCH -t 1-00:00:00
#SBATCH -J Wang_2023_sanity
#SBATCH -o /mimer/NOBACKUP/groups/kthmech/nvlmds/super-resolution/logs/Wang_2023_sanity_%j.out
#SBATCH -e /mimer/NOBACKUP/groups/kthmech/nvlmds/super-resolution/logs/Wang_2023_sanity_%j.err

...
python pipelines/Wang_2023_runDualSRNetSlimCoupled.py \
    ...
    --modelName Wang_2023 \
    --augFlag True \
    --dataset_dir /mimer/NOBACKUP/groups/kthmech/nvlmds/super-resolution/data/processed/Wang_2023_synthetic/training/ \
    --val_dataset_dir /mimer/NOBACKUP/groups/kthmech/nvlmds/super-resolution/data/processed/Wang_2023_synthetic/validation/ \

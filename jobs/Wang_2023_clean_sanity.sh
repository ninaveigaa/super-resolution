...
#SBATCH -t 00:10:00
#SBATCH -J Wang_2023_clean_sanity
#SBATCH -o /mimer/NOBACKUP/groups/kthmech/nvlmds/super-resolution/logs/Wang_2023_clean_sanity_%j.out
#SBATCH -e /mimer/NOBACKUP/groups/kthmech/nvlmds/super-resolution/logs/Wang_2023_clean_sanity_%j.err

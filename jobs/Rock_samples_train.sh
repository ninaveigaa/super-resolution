...
python pipelines/Wang_2023_runDualSRNetSlimCoupled.py \
    ...
    --gpuIDs 0 \
    --modelName Wang_2023 \
    --dataset_dir /mimer/NOBACKUP/groups/kthmech/nvlmds/super-resolution/data/processed/rock_samples/training/ \
    --val_dataset_dir /mimer/NOBACKUP/groups/kthmech/nvlmds/super-resolution/data/processed/rock_samples/validation/ \

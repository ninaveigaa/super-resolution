...
OUT_DIR = Path("data/processed/Wang_2023_og")
...
def prepare_data():
    ...
    final_paths = {
        OUT_DIR / "training" / "LR" / "LR.npy": lr_cropped,
        OUT_DIR / "training" / "HR" / "HR.npy": hr_cropped
    }
    ...
    print(f"\nData preparation done. Final files ready under {OUT_DIR}/training/")
